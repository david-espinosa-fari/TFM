...
final class InMemoryStationRepositoryMysql implements StationRepository
{
    private $conect;
    ...
    {
        if ($uuidStation===false)
        {
            throw new StationErrorException('Station ' . $uuidStation . ' not Found', 404);
        }
                $response['uuidStation']='test';
                $response['uuidUser']='test';
                $response['latitud']='test';
                $response['longitud']='test';
                $response['temp']='test';
                $response['humidity']='test';
                $response['presion']='test';
                $response['location']='test';
                $response['state']='test';
                $response['postalCode']='test';
