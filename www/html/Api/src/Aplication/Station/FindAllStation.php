...
final class FindAllStation
{
	...
	public function __invoke():array
	{
		...
		if (!empty($response))
		{
			return $this->convertJsonToStandardResponse($response);

		}
			return $this->findWithOutCache($query);
	}

	private function findWithOutCache($query):array
	{
	...
	private function convertJsonToStandardResponse(array $response):array
	{
		$stations=[];
